...
setup(name='bulbs_garnish',
      ...
      py_modules=['matarisvan.operations', 'matarisvan.operation_graph.entities', 'matarisvan.operation_graph.data_operations', 'matarisvan.operation_graph.generation_rules']
     )
